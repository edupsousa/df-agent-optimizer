...
declare module "graphlib" {
  ...
  export class Graph<TGraphLabel = any, TNodeLabel = any, TEdgeLabel = any> {
     ...
     */
    setDefaultNodeLabel(label: TNodeLabel): Graph;
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setDefaultNodeLabel(labelFn: (v: string) => TNodeLabel): Graph;
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setNode(name: string, label?: TNodeLabel): Graph;
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setNodes(names: string[], label?: TNodeLabel): Graph;
     ...
     */
    filterNodes(filter: (v: string) => boolean): Graph<TNodeLabel>;
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setDefaultEdgeLabel(label: TEdgeLabel): Graph;
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setDefaultEdgeLabel(labelFn: (v: string) => TEdgeLabel): Graph;
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setPath(nodes: string[], label?: TEdgeLabel): Graph;
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setEdge(v: string, w: string, label?: TEdgeLabel, name?: string): Graph;
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setEdge(edge: Edge, label?: TEdgeLabel): Graph;
     ...
     */
    edge(v: string, w: string, name?: string): TEdgeLabel;
     ...
     * @returns the graph, allowing this to be chained with other functions.
     */
    setGraph(label: TGraphLabel): Graph;
